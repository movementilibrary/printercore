...
public enum MensagemErroType {
    ...
    ERRO_INSERIR_IMPRESSORA_POR_UNIDADE("N�o foi possivel inserir impressora na lista da unidade" ),
    ERRO_EXCLUIR_IMPRESSORA_POR_UNIDADE("N�o foi possivel excluir impressora da unidade");
